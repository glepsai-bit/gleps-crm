...
const STATUS: Record<RunStatus, { label: string; classe: string }> = {
  ...
  // Follow-up agendado: o atendimento não acabou, só tem hora marcada pra
  // continuar. Mostrar como "concluída" mentiria sobre o estado.
  sleeping: { label: 'Aguardando', classe: 'bg-amber-500/15 text-amber-600 border-amber-500/30' },
